...
public class Metodos {
    ...
    public String[] arrayNombre(){
        ...
        for (int i = 0; i < nombres.length; i++){
            nombres[i] = PedirDatos.getString("Teclee o nome do " + (i+1) +"º alumno");
        }
        return nombres;
    }
    ...
    public void amosarNotaMedia(int notas[]){
        ...
        System.out.println("A nota media é de: " + media);
    }
    ...
    public void amosarNotaDeterminada(String nombres[], int notas[]){
        ...
        if(num == 0){
            System.out.println("Nome no encontrado");
        }
    }
    ...
    public void amosarAprobados(String nombres[], int notas[]){
        ...
        if (num == 0){
            System.out.println("No aprobó ninguén");
        }
    }
    ...
    public void ordernarLista(String nombres[], int notas[]){
        ...
        System.out.println("Lista ordeada:");
        for(int i = 0; i < notas.length; i++){
    ...
    public void calcularLetraNIF(){
        ...
        while(num < 10000000 || num > 100000000){
            num = PedirDatos.getLong("O numero do NIF ten que ter 8 digitos, sendo 10000000 a primera combinacion posible ");
        }
        float div = num%23;
        int resto = (int) div;
