...
public class Metodos {
    ...
    String []equipos = {" Real Madrid     ", "Barcelona    ", "Atlético Madrid", "Real Sociedad  ", "Villareal      ", "Betis          ", "Osasuna        ", "Athletic       ", "Rayo Vallecano ", "R.C.D Mallorca ", "Almería        ", "Girona         ", "Sevilla        ", "Valencia C.F.  ", "RCD Espanyol   ", "Celta de Vigo  ", "Valladolid     ", "Cádiz          ", "Getafe         ", "Elche C.F      "};
